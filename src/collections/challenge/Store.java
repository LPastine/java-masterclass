...
public class Store {
    ...
    private void stockStore() {
        ...
        List<Product> products = new ArrayList<>(List.of(
                ...
                new Product("M201", "milk", "local", Category.DAIRY),
                new Product("Y001", "yogurt", "local", Category.DAIRY),
                new Product("C333", "cheese", "local", Category.DAIRY),
                new Product("R777", "rice chex", "local", Category.CEREAL),
                new Product("G111", "granola", "local", Category.CEREAL),
                new Product("BB11", "ground beef", "local", Category.MEAT),
                new Product("CC11", "chicken", "local", Category.MEAT),
                new Product("BC11", "bacon", "local", Category.MEAT),
                new Product("BC77", "coke", "local", Category.BEVERAGE),
                new Product("BC88", "coffee", "local", Category.BEVERAGE),
                new Product("BC99", "tea", "local", Category.BEVERAGE)
        ));
